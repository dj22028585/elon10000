          ...
          >
            <div className="relative w-full h-48 flex items-center justify-center bg-black/30">
              {sub.image ? (
                ...
                <div className="flex items-center justify-center w-full h-full text-2xl text-muted">
                  ???
                </div>
              )}
            </div>
